...
EXPECTED_RESULT="src/test/resources/results/expected/passedTransactionsTest.txt"
ACTUAL_RESULT="src/test/resources/results/actual/passedTransactionsTest.txt"

java \
    -jar target/lightning*.jar \
    -xml src/test/resources/xml/passedTransactionsTest.xml \
